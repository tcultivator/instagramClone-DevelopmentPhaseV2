            ...
            if (isMedia) {
                ...
                if (isImage) {
                    ...
                    <div id="informationAndMessagesRight" data-id="${element.senderId}">
                        ...
                        <img id="senderUserImageRight" src="${element.senderImage}" alt="" data-userid="${element.senderId}">
                    ...
                    <div id="informationAndMessagesLeft" data-id="${element.senderId}">
                        <img id="senderUserImageLeft" src="${element.senderImage}" alt="" data-userid="${element.senderId}">
